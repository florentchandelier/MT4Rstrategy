...
Please carefully review information highlighting some of the most significant risks that Forex transactions may pose for individual investors, from United States Commodity Futures Trading Commission (CFTC) 
[“COMMISSION ADVISORY BEWARE OF FOREIGN CURRENCY TRADING FRAUDS”](http://www.cftc.gov/opa/enf98/opaforexa15.htm), 
United States Securities and Exchange Commission (SEC) [“INVESTOR BULLETING: FOREIGN CURRENCY EXCHANGE (FOREX) TRADING FOR INDIVIDUAL INVESTORS“](http://www.sec.gov/news/press/2011/2011-150.htm) and the 
European Securities and Markets Authority (ESMA) [“INVESTING IN FOREIGN EXCHANGE (FOREX)”](http://www.esma.europa.eu/news/Investing-foreign-exchange-forex?t=326&o=home)
...
foreign exchange, futures or other products, you should carefully consider, **with support from competent counsel in the matter of money management as legally defined in its jurisdiction**, 
your financial objectives, level of experience, and risk appetite. 
...
All performance claims on this web site about trading system performance must be regarded as hypothetical. There is often a vast difference between hypothetical results and real-life trading results achievable in an a 
real brokerage account, and real-life results are almost always vastly worse than hypothetical results. Simulated or hypothetical trading programs in general are also subject to the fact that they are designed with the benefit of hindsight. 
